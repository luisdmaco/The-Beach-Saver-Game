...
namespace trabajofinal {
	...
	private: System::Windows::Forms::Label^ label16_tiempo;
	private: System::Windows::Forms::Label^ label15;
	private: System::Windows::Forms::Timer^ timer2_tiempo;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label16_tiempo = (gcnew System::Windows::Forms::Label());
			...
			this->timer2_tiempo = (gcnew System::Windows::Forms::Timer(this->components));
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timer1_Tick_1);
			// 
			// timerEnemy
			// 
			this->timerEnemy->Enabled = true;
			this->timerEnemy->Interval = 750;
			this->timerEnemy->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timerEnemy_Tick);
			// 
			// timerBasura
			// 
			this->timerBasura->Enabled = true;
			this->timerBasura->Interval = 400;
			this->timerBasura->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timerBasura_Tick);
			// 
			// timerEntierro
			// 
			this->timerEntierro->Enabled = true;
			this->timerEntierro->Interval = 90;
			this->timerEntierro->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timerEntierro_Tick);
			// 
			// panel2
			// 
			...
			this->panel2->Location = System::Drawing::Point(704, 12);
			...
			this->groupBox4->Controls->Add(this->label16_tiempo);
			this->groupBox4->Controls->Add(this->label15);
			this->groupBox4->Location = System::Drawing::Point(8, 50);
			this->groupBox4->Name = L"groupBox4";
			this->groupBox4->Size = System::Drawing::Size(221, 69);
			...
			this->label16->Location = System::Drawing::Point(155, 25);
			...
			// label16_tiempo
			// 
			this->label16_tiempo->AutoSize = true;
			this->label16_tiempo->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label16_tiempo->Location = System::Drawing::Point(98, 17);
			this->label16_tiempo->Name = L"label16_tiempo";
			this->label16_tiempo->Size = System::Drawing::Size(26, 29);
			this->label16_tiempo->TabIndex = 1;
			this->label16_tiempo->Text = L"0";
			// 
			// label15
			// 
			this->label15->AutoSize = true;
			this->label15->Font = (gcnew System::Drawing::Font(L"Showcard Gothic", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label15->Location = System::Drawing::Point(22, 25);
			this->label15->Name = L"label15";
			this->label15->Size = System::Drawing::Size(76, 18);
			this->label15->TabIndex = 0;
			this->label15->Text = L"TIEMPO : ";
			// 
			// groupBox3
			// 
			...
			this->groupBox2->Location = System::Drawing::Point(3, 300);
			...
			this->groupBox1->Location = System::Drawing::Point(3, 125);
			...
			this->timerMicrobiologicoBaños->Interval = 200;
			this->timerMicrobiologicoBaños->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timerMicrobiologicoBaños_Tick);
			// 
			// timer2_tiempo
			// 
			this->timer2_tiempo->Enabled = true;
			this->timer2_tiempo->Interval = 1000;
			this->timer2_tiempo->Tick += gcnew System::EventHandler(this, &MyForm_level_02::timer2_tiempo_Tick);
			// 
			// MyForm_level_02
			// 
			...
			this->Text = L"MyForm_level02";
			this->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &MyForm_level_02::MyForm_level_02_KeyDown);
			this->KeyUp += gcnew System::Windows::Forms::KeyEventHandler(this, &MyForm_level_02::MyForm_level02_KeyUp);
...
#pragma endregion
	private: System::Void timer1_Tick_1(System::Object^ sender, System::EventArgs^ e) {
		...
		this->label16_tiempo->Text = Convert::ToString(tiempo);
		//collision
		...
		if (controller->getMicrobiologico() < 0  || tiempo == 0)  // funcion opcional de perder 
		{
			timer1->Enabled = false;
			timerBasura->Enabled = false;
			timerEnemy->Enabled = false;
	...
	private: System::Void MyForm_level02_KeyUp(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
...
private: System::Void MyForm_level_02_KeyDown(System::Object^ sender, System::Windows::Forms::KeyEventArgs^ e) {
	...
	if (groupBox2->Enabled == true)
	{
      ...
      private: System::Void timer2_tiempo_Tick(System::Object^ sender, System::EventArgs^ e) {
		  tiempo--;
     }
};
}
